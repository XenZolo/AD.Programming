...
const BookingHistory = () => {
  ...
  const handleUpdate = (bookingId) => {
    navigate("/updatebooking", { state: { role, userId, token, bookingId } });
  };
    ...
    <div className="container-fluid bg-light min-vh-100">
      <div className="bg-white py-4">
        <div className="container d-flex justify-content-between align-items-center">
          <h1 className="h3 mb-0 text-black">Completed Bookings</h1>
        </div>
      </div>
        ...
        <Table striped bordered hover responsive variant="light" className="shadow-sm">
          ...
          <tbody>
            {Array.isArray(bookings) && bookings.length > 0 ? (
              ...
              <tr>
                <td colSpan="10">No completed bookings available.</td>
              </tr>
            )}
          </tbody>
        </Table>
